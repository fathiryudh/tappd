...
export default function LegacyRegisterPreview() {
  ...
  return (
    <div className="min-h-[100dvh] flex bg-zinc-950 text-zinc-50">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-20 bg-zinc-950">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? 'Creating account...' : <>Create account <ArrowRight size={15} weight="bold" /></>}
            </motion.button>
          </form>

          <p className="mt-6 text-sm text-zinc-600">
            Have an account?{' '}
            <Link to="/preview/legacy/login" className="text-zinc-300 hover:text-zinc-100 font-medium transition-colors duration-150">
              Sign in
            </Link>
          </p>
        </MotionDiv>
