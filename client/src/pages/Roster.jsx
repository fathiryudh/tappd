            ...
            <div className="flex flex-col items-start md:items-end gap-3">
              ...
              {isCurrentWeek && !loading && data && (
                <div className="flex flex-wrap gap-1.5">
                  <span className={`rounded-full px-3 py-1 text-[11px] font-semibold ${PILL.in}`}>
                    {inCount} in
                  </span>
                  <span className={`rounded-full px-3 py-1 text-[11px] font-semibold ${PILL.out}`}>
                    {outCount} out
                  </span>
                  {unconfirmed > 0 && (
              ...
              <div className="flex items-center gap-0.5">
                ...
                {!isCurrentWeek && (
                  <button
                    ...
                    onMouseEnter={e => { e.currentTarget.style.background = 'rgba(0,0,0,0.06)'; e.currentTarget.style.color = 'rgba(0,0,0,0.7)' }}
                    onMouseLeave={e => { e.currentTarget.style.background = ''; e.currentTarget.style.color = 'rgba(0,0,0,0.45)' }}
                  >
                    Today
                  </button>
                )}
                        ...
                        {week.map((date, i) => {
                          ...
                          return (
                            <th
                              ...
                              style={{
                                background: isToday ? 'rgba(0,0,0,0.02)' : 'transparent',
                              }}
                            >
                              <span
